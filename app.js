...
const RELEASE_NOTES = [
  { version: "3.1.0", date: "2026-09-23", items: [
    "ספירת שימוש אנונימית: המועדון יודע כמה משתמשים באפליקציה וכמה רושמים אימונים — בלי שם ובלי שום פרט מהאימונים. אפשר לכבות בהגדרות ← ספירת שימוש",
  ] },
  ...
  return `
    <div class="settings-pane">
      ...
      <div class="settings-block">
        ...
        <div class="footer-note" style="margin-bottom:8px;">כדי שהמועדון ידע כמה משתמשים באפליקציה, נספרים באופן אנונימי רק פתיחת האפליקציה, רישום אימון ופתיחת מסך — בלי שם ובלי שום פרט מהאימונים.</div>
